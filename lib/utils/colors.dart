...
const Color textTertiary = Color(0xffd1d5db);
const Color textLabel = Color(0xff9ca3af);
const Color textSubtle = Color(0xff6b7280);

// --- Accent Colors ---
const Color primaryAccent = Color(0xff818cf8);
const Color buttonPrimary = Color(0xff4f46e5);
...
const Color avatarPurple = Color(0xff7e22ce);
const Color avatarYellow = Color(0xfffacc15);
const Color avatarGreen = Color(0xff4ade80);
const Color avatarRed = Color(0xffe11d48);
const Color avatarBlue = Color(0xff3b82f6);